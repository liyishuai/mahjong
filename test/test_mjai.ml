...
let test_bound_checking () =
  ...
  (try
    ...
    assert false
  with Mjai.Out_of_bound _ -> ());

  (* Kyoku out of bounds *)
  (try
    let _ = Mjai.Json.event_from_string
      {|{"type":"start_kyoku","bakaze":"E","dora_marker":"5s","kyoku":0,"honba":0,"kyotaku":0,"oya":0,"scores":[25000,25000,25000,25000],"tehais":[["N","3p","W","W","7m","N","S","C","7m","P","8p","2m","5m"],["7p","1p","2m","3m","4m","C","7s","7s","9s","9p","1m","C","1s"],["3s","E","5m","P","5m","F","7p","6m","5s","9p","1s","S","N"],["2p","4s","4p","E","5p","F","3p","1s","8p","6s","8s","7s","5p"]]}|} in
    assert false
  with Mjai.Out_of_bound _ -> ());
