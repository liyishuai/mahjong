...
let test_properties () =
  ...
  assert (Tiles.is_jihai (Tiles.tile_of_int_exn 27)); (* E *)
  assert (not (Tiles.is_jihai (Tiles.tile_of_int_exn 0))); (* 1m *)

  (* Test yaokyuu (terminals and honors) *)
  assert (Tiles.is_yaokyuu (Tiles.tile_of_int_exn 0)); (* 1m *)
  assert (Tiles.is_yaokyuu (Tiles.tile_of_int_exn 8)); (* 9m *)
  assert (Tiles.is_yaokyuu (Tiles.tile_of_int_exn 27)); (* E *)
  assert (not (Tiles.is_yaokyuu (Tiles.tile_of_int_exn 4))); (* 5m *)
